...
type CategoryService interface {
	...
	UpdateCategory(id uint, req domain.NewCategoryRequest) (*domain.Category, error)
...
func (s *categoryService) FindCategoryByID(id uint) (*domain.Category, error) {
...
func (s *categoryService) UpdateCategory(id uint, req domain.NewCategoryRequest) (*domain.Category, error) {
